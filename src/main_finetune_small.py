...
from segmamba_small import SegMamba
...
# model = nn.data.parralell(model)
    if cfg.DATA.shift_channels is not None:
        ...
        cfg.shift = None
    # dataset_train = Trainset(cfg, [18,160,160])  # [16,256,256] [16,160,160] [32,320,320]
    # dataset_train = Trainset(cfg, [16,160,160])  # [16,256,256] [16,160,160] [32,320,320]
    ...
    # )
    # model = SwinUMamba(in_chans=1, out_chans=3, deep_supervision=True)
