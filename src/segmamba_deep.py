...
class MambaEncoder(nn.Module):
    def __init__(self, in_chans=1, depths=[2, 2, 2, 2, 2], dims=[16, 32, 64, 128, 256],
...
class SegMamba_deep(nn.Module):
    ...
    def forward(self, x_in, x_gt = None):
        ...
        enc_hidden = self.encoder6(outs[4])  # outs[3]:[6,256,1,10,10]
